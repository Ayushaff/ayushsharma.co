...
import './a.min.css';
import b from './assets/ayush.jpg';
  ...
  return (
    <section className="v">
      <figure className="w" onMouseEnter={l}>
        ...
        {/* </div> */}
        <div className="ag" style={{ top:10, left: 0, width: '100%', height: '100%'}}>
          <img src={"https://ayusharma.s3.ap-southeast-2.amazonaws.com/ayush.jpg"} alt=""/>
        </div>
      </figure>
    </section>
  );
