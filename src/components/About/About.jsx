      ...
      >
        ...
        <GridItem colSpan={{ base: 2, md: 1, lg: 1 }}>
          ...
          >
            ...
            Information Technology from Ujjain Engineering college, Ujjain.
            <br />
            <br />
            ...
            <br />
            <br />. In my free time, you'll find me working on{" "}
            <i>projects, experimenting with new technologies</i>
            <br />
            <br />
            📔 Currently, I'm doing DSA+Development while aiming for{" "}
            <a href="/resume">
              <i>
                <u>the Tech Company</u>
              </i>
            </a>
            ...
            <br />
            <Box
              display={{ base: "none", md: "block", lg: "-22px" }}
